...
namespace XXLarge.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductsId,UsersId,Quantity,OrderOn")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductsId,UsersId,Quantity,OrderOn")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
